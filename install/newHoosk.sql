...
START TRANSACTION;
USE `hoosk`;
INSERT INTO `hoosk`.`hoosk_navigation` (`id`, `navSlug`, `navTitle`, `navHTML`, `navEdit`) VALUES (1, 'header', 'Header Nav', '<ul class=\"nav navbar-nav\"><li><a href=\"http://beta.hoosk.org\">Home</a></li><li><a href=\"/contact\">Contact</a></li><li><a href=\"/news\">News</a></li></ul>', DEFAULT);
INSERT INTO `hoosk`.`hoosk_navigation` (`id`, `navSlug`, `navTitle`, `navHTML`, `navEdit`) VALUES (2, 'test', 'test', '<ul class=\"nav navbar-nav\"></ul>', DEFAULT);
...
INSERT INTO `hoosk`.`hoosk_jumbotron` (`jumbotron_id`, `jumbotron`, `jumbotronHTML`) VALUES (3, DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `hoosk`;
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (2, 'facebook', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (3, 'google', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (4, 'pinterest', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (5, 'foursquare', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (6, 'linkedin', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (7, 'myspace', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (8, 'soundcloud', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (9, 'spotify', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (10, 'lastfm', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (11, 'youtube', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (12, 'vimeo', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (13, 'dailymotion', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (14, 'vine', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (15, 'flickr', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (16, 'instagram', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (17, 'tumblr', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (18, 'reddit', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (19, 'envato', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (20, 'github', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (21, 'tripadvisor', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (22, 'stackoverflow', DEFAULT, 0);
INSERT INTO `hoosk`.`hoosk_social` (`id`, `socialName`, `socialLink`, `socialEnabled`) VALUES (23, 'persona', DEFAULT, 0);
...
START TRANSACTION;
USE `hoosk`;
INSERT INTO `hoosk`.`hoosk_user` (`userID`, `userName`, `email`, `password`, `role`, `RS`) VALUES (2, 'demo', 'info@hoosk.org', '76d1e5ade32152e80c4e3aa926d51c44', 'owner', DEFAULT);
INSERT INTO `hoosk`.`hoosk_user` (`userID`, `userName`, `email`, `password`, `role`, `RS`) VALUES (1, 'webcurators', 'thewebcurators@gmail.com', '1234', 'admin', DEFAULT);
